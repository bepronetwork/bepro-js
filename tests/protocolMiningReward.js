...
import { ERC20Contract, ETHUtils, ERC20Mock, ProtocolMiningReward } from '../build';
...
const deployProtocolMiningReward = async ({ startBlockNumber = 1, rewardTokenAddress, rewardTokenAmount } = {}) => {
	...
	let res = await protocolMiningReward.deploy(testConfig2);
...
context('ProtocolMiningReward', async () => {
  ...
  it('should deploy an ERC20 Reward token', mochaAsync(async () => {
    ...
    let res = await erc20RewardToken.deploy({
      name: 'RewardToken',
      symbol: 'RWT',
      cap: Numbers.fromBNToDecimals(erc20TokenSupply, 18),
      distributionAddress: userAddress, //local test with ganache
  ...
  it('encodeERC20Transfer/decodeERC20Transfer tests',
    mochaAsync(async () => {
  ...
  it('user trying to approveCall should revert',
    mochaAsync(async () => {
  ...
  it('should update already approved call',
    mochaAsync(async () => {
  ...
  //approveCallData
  it('user trying to approveCallData should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('owner should approveCallData',
    mochaAsync(async () => {
  ...
  it('should update already approved callData',
    mochaAsync(async () => {
      // following attributes have to be different than previous so we can check if call is being updated
      let rewardTokenAmount = BigNumber(10500);
  ...
  //approveBatch
  it('user trying to approveBatch should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('should update already approved batch',
    mochaAsync(async () => {
      // following attributes have to be different than previous so we can check if call is being updated
      let rewardTokenAmount = BigNumber(10500);
  ...
  //approveBatchData
  it('user trying to approveBatchData should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('owner should approveBatchData',
    mochaAsync(async () => {
  ...
  it('should update already approved batchData',
    mochaAsync(async () => {
      // following attributes have to be different than previous so we can check if call is being updated
      let rewardTokenAmount = BigNumber(10500);
  ...
  it('user trying to disapproveCall should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('owner should disapproveCall',
    mochaAsync(async () => {
  ...
  it('only approved call can be disapproved',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
        () => protocolMiningReward.disapproveCall({
          target,
  ...
  //disapproveCallData
  it('user trying to disapproveCallData should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('owner should disapproveCallData',
    mochaAsync(async () => {
  ...
  it('only approved callData can be disapproved',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
        () => protocolMiningReward.disapproveCallData({
          target,
  ...
  //disapproveBatch
  it('user trying to disapproveBatch should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('owner should disapproveBatch',
    mochaAsync(async () => {
  ...
  it('only approved batch can be disapproved',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
        () => protocolMiningReward.disapproveBatch({
          targets,
  ...
  //disapproveBatchData
  it('user trying to disapproveBatchData should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('owner should disapproveBatchData',
    mochaAsync(async () => {
  ...
  it('only approved batchData can be disapproved',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
        () => protocolMiningReward.disapproveBatchData({
          targets,
  ...
  //disapproveAll
  it('user trying to disapproveAll should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('trying to execute disapproved call should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('trying to executeData disapproved call should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('trying to executeBatch call with different length arrays input should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('trying to executeBatch disapproved call should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
        async () => await protocolMiningReward.executeBatch({
          targets,
          values: [0, 0],
          funcSelectors,
          callParams,
  ...
  it('trying to executeBatchData call with different length arrays input should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
  ...
  it('trying to executeBatchData disapproved call should revert',
    mochaAsync(async () => {
      await beproAssert.revertsFn(
        () => protocolMiningReward.executeBatchData({
          targets,
  ...
  it('get call hash by index on invalid index should revert',
    mochaAsync(async () => {
  ...
  it('should execute approved call and get token rewards',
    mochaAsync(async () => {
  ...
  it('should executeData approved call with strict given params only and get token rewards',
    mochaAsync(async () => {
      // transfer ERC20 tokens to contract so it can send them via approved call
      await erc20Token.transferTokenAmount({ toAddress: protocolMiningReward.getAddress(), tokenAmount: transferTokenAmount });
      const newBalance = await erc20Token.balanceOf(protocolMiningReward.getAddress());
      ...
      const callDataFail = encodeFuncSigWithParams(
        'transfer(address,uint256)',
        ['address','uint256'], [userAddress3, transferTokenAmountRaw],
      );
      ...
      const callDataFail2 = encodeFuncSigWithParams(
        'transfer(address,uint256)',
        ['address','uint256'], [userAddress2, BigNumber(transferTokenAmountRaw).plus(100)],
      );
  ...
  it('should executeBatch approved call and get token rewards (with transferFrom)',
    mochaAsync(async () => {
      // NOTES:
  ...
  it('should executeBatchData approved call with strict given params only and get token rewards',
    mochaAsync(async () => {
      ...
      const callDataFail = encodeFuncSigWithParams(
        ...
        ['address','uint256'], [userAddress2, transferTokenAmountRaw],
      );
      ...
      const callData2Fail = encodeFuncSigWithParams(
        'transfer(address,uint256)',
        ['address','uint256'], [userAddress2, transferTokenAmountRawFail],
      );
  ...
  /// PRE-REQUISITE:
  /// erc20Token contract should NOT be able to receive ETH for this test case to pass
  it('sending ETH value to non-receiving contract address should revert',
    mochaAsync(async () => {
      const ethvalue = '1';
  ...
  it('send ETH value and get reward tokens',
    mochaAsync(async () => {
      const ethvalue = '1';
      const ethvalueWei = web3.utils.toWei(ethvalue, 'ether');
