require(['gitbook', 'jquery'], (gitbook, $) => {
  ...
  function getFontFamilyId(configName) {
    ...
    const configFamily = $.grep(FAMILIES, family => family.config == configName)[0];
  ...
  function getThemeId(configName) {
    ...
    const configTheme = $.grep(THEMES, theme => theme.config == configName)[0];
