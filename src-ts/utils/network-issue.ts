...
type Params = [string, string, string, string, string, string, boolean, boolean, boolean]
...
export default function networkIssue([_id, cid, creationDate, tokensStaked, issueGenerator,
  ...
  return {
    _id: _id.toString(), cid, issueGenerator, finalized, canceled, recognizedAsFinished,
