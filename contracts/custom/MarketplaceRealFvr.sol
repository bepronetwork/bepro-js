...
contract MarketplaceRealFvr is ERC721Marketplace {
    ...
    IOpenerRealFvr public erc721Address;

    constructor(
        IERC20 _erc20Address,
        IOpenerRealFvr _erc721Address)
        public
        ERC721Marketplace(_erc20Address, _erc721Address)
    {
        erc721Address = _erc721Address;
    }

    function removeERC721FromSaleAdmin(uint256 _tokenId) public
        onlyOwner
