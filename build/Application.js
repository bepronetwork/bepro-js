...
{var _this = this;var _ref$test = _ref.test,test = _ref$test === undefined ? false : _ref$test,_ref$localtest = _ref.localtest,localtest = _ref$localtest === undefined ? false : _ref$localtest,_ref$mainnet = _ref.mainnet,mainnet = _ref$mainnet === undefined ? true : _ref$mainnet,_ref$opt = _ref.opt,opt = _ref$opt === undefined ? { web3Connection: ETH_URL_MAINNET } : _ref$opt;(0, _classCallCheck3.default)(this, Application);this.
  ...
  start = function () {
    ...
    new _web2.default.providers.HttpProvider(_this.opt.web3Connection));else
    ...
    //if (this.test)
    else _this.web3 = new _web2.default(new _web2.default.providers.HttpProvider(ETH_URL_TESTNET));
  ...
  getERC721Collectibles = function () {var _ref6 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref6$customID = _ref6.customID,customID = _ref6$customID === undefined ? 1 : _ref6$customID,_ref6$contractAddress = _ref6.contractAddress,contractAddress = _ref6$contractAddress === undefined ? null : _ref6$contractAddress;
    try {
      switch (customID) {
        case 0:{
  ...
  getERC20Contract = function (_ref7) {var _ref7$contractAddress = _ref7.contractAddress,contractAddress = _ref7$contractAddress === undefined ? null : _ref7$contractAddress;
    try {
