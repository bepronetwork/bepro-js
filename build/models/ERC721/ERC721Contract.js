  ...
  function ERC721Contract() {var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};(0, _classCallCheck3.default)(this, ERC721Contract);var _this = (0, _possibleConstructorReturn3.default)(this, (ERC721Contract.__proto__ || (0, _getPrototypeOf2.default)(ERC721Contract)).call(this, (0, _extends3.default)({
    ...
    /**
        ...
        to = _ref13.to,approve = _ref13.approve;return _regenerator2.default.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:_context8.next = 2;return (
                  this.__sendTx(
                  this.params.contract.getContract().methods.setApprovalForAll(to, approve)));case 2:return _context8.abrupt('return', _context8.sent);case 3:case 'end':return _context8.stop();}}}, _callee8, this);}));function setApprovalForAll(_x6) {return _ref12.apply(this, arguments);}return setApprovalForAll;}() }]);return ERC721Contract;}(_IContract3.default);var _initialiseProps = function _initialiseProps() {var _this2 = this;this.__assert = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9() {return _regenerator2.default.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:if (_this2.getAddress()) {_context9.next = 2;break;}throw new Error('Contract is not deployed, first deploy it and provide a contract address');case 2: /* Use ABI */_this2.params.contract.use(_interfaces.erc721contract, _this2.getAddress());case 3:case 'end':return _context9.stop();}}}, _callee9, _this2);}));this.setBaseTokenURI = function () {var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(_ref16) {var URI = _ref16.URI;return _regenerator2.default.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:_context10.next = 2;return _this2.__sendTx(_this2.params.contract.getContract().methods.setBaseURI(URI));case 2:return _context10.abrupt('return', _context10.sent);case 3:case 'end':return _context10.stop();}}}, _callee10, _this2);}));return function (_x7) {return _ref15.apply(this, arguments);};}();this.



  deploy = function () {var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(_ref18) {var name = _ref18.name,symbol = _ref18.symbol,callback = _ref18.callback;var params, res;return _regenerator2.default.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:if (
              name) {_context11.next = 2;break;}throw (
                new Error('Please provide a name'));case 2:if (


              symbol) {_context11.next = 4;break;}throw (
                new Error('Please provide a symbol'));case 4:

              params = [name, symbol];_context11.next = 7;return (
                _this2.__deploy(params, callback));case 7:res = _context11.sent;
              _this2.params.contractAddress = res.contractAddress;
              /* Call to Backend API */_context11.next = 11;return (
                _this2.__assert());case 11:return _context11.abrupt('return',
              res);case 12:case 'end':return _context11.stop();}}}, _callee11, _this2);}));return function (_x8) {return _ref17.apply(this, arguments);};}();};exports.default =
