...
ERC20TokenLock = function (_IContract) {(0, _inherits3.default)(ERC20TokenLock, _IContract);
  function ERC20TokenLock() {var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};(0, _classCallCheck3.default)(this, ERC20TokenLock);
    try {var _this = (0, _possibleConstructorReturn3.default)(this, (ERC20TokenLock.__proto__ || (0, _getPrototypeOf2.default)(ERC20TokenLock)).call(this, (0, _extends3.default)({},
      ...
      console.log('ERC20TokenLock.ctor.contractAddress: ' +
  ...
  /**
     ...
     * @returns {Address}
     */(0, _createClass3.default)(ERC20TokenLock, [{ key: 'erc20', value: function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
    ...
    /**
                  ...
                  call());case 2:res = _context2.sent;return _context2.abrupt('return',
                _Numbers2.default.fromDecimals(res, this.getERC20Contract().getDecimals()));case 4:case 'end':return _context2.stop();}}}, _callee2, this);}));function totalAmountStaked() {return _ref2.apply(this, arguments);}return totalAmountStaked;}()
    ...
    /**
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                */ }, { key: 'minAmountToLock', value: function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {var res;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (

                  this.params.contract.
                  getContract().
                  methods.minAmountToLock().
                  call());case 2:res = _context3.sent;return _context3.abrupt('return',
                _Numbers2.default.fromDecimals(res, this.getERC20Contract().getDecimals()));case 4:case 'end':return _context3.stop();}}}, _callee3, this);}));function minAmountToLock() {return _ref3.apply(this, arguments);}return minAmountToLock;}()
    ...
    /**
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            */ }, { key: 'maxAmountToLock', value: function () {var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {var res;return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (

                  this.params.contract.
                  getContract().
                  methods.maxAmountToLock().
                  call());case 2:res = _context4.sent;return _context4.abrupt('return',
                _Numbers2.default.fromDecimals(res, this.getERC20Contract().getDecimals()));case 4:case 'end':return _context4.stop();}}}, _callee4, this);}));function maxAmountToLock() {return _ref4.apply(this, arguments);}return maxAmountToLock;}()
    ...
    /**
              ...
              res);case 10:case 'end':return _context15.stop();}}}, _callee15, _this2);}));return function () {return _ref24.apply(this, arguments);};}();this.
