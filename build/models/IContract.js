...
var _Contract = require('../utils/Contract');var _Contract2 = _interopRequireDefault(_Contract);
...
IContract = function () {
  ...
  {var _ref$web3Connection = _ref.web3Connection,web3Connection = _ref$web3Connection === undefined ? null : _ref$web3Connection,_ref$contractAddress = _ref.contractAddress,contractAddress = _ref$contractAddress === undefined ? null : _ref$contractAddress,abi = _ref.abi,tokenAddress = _ref.tokenAddress,params = (0, _objectWithoutProperties3.default)(_ref, ['web3Connection', 'contractAddress', 'abi', 'tokenAddress']);(0, _classCallCheck3.default)(this, IContract);_initialiseProps.call(this);
    try {
      ...
      new _Web3Connection2.default(params) :
      web3Connection;
  ...
  /**
    ...
    /**
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              * @throws {Error}
                                                                                                                                                                                                              */ }, { key: 'onlyOwner', value: function () {var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10() {var adminAddress, userAddress, isAdmin;return _regenerator2.default.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:_context10.next = 2;return (


                  this.owner());case 2:adminAddress = _context10.sent;_context10.next = 5;return (
                  this.getUserAddress());case 5:userAddress = _context10.sent;
                isAdmin = adminAddress === userAddress;if (
                isAdmin) {_context10.next = 9;break;}throw (
                  new Error('Only admin can perform this operation'));case 9:case 'end':return _context10.stop();}}}, _callee10, this);}));function onlyOwner() {return _ref15.apply(this, arguments);}return onlyOwner;}()
    ...
    /**
                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                             * @throws {Error}
                                                                                                                                                                                                                             */ }, { key: 'whenNotPaused', value: function () {var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11() {var paused;return _regenerator2.default.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:_context11.next = 2;return (


                  this.isPaused());case 2:paused = _context11.sent;if (!
                paused) {_context11.next = 5;break;}throw (
                  new Error('Contract is paused'));case 5:case 'end':return _context11.stop();}}}, _callee11, this);}));function whenNotPaused() {return _ref16.apply(this, arguments);}return whenNotPaused;}()
    ...
    /**
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  */ }, { key: '_loadDataFromWeb3Connection', value: function _loadDataFromWeb3Connection()
    {
      ...
      this.params, {
        web3: this.web3,
        contract: new _Contract2.default(
        this.web3,
        this.params.abi,
    ...
    /**
                  ...
                  */ }, { key: 'start', value: function () {var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12() {return _regenerator2.default.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:

                this.web3Connection.start();
                this._loadDataFromWeb3Connection();case 2:case 'end':return _context12.stop();}}}, _callee12, this);}));function start() {return _ref17.apply(this, arguments);}return start;}()
    ...
    /**
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  */ }, { key: 'login', value: function () {var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13() {var loginOk;return _regenerator2.default.wrap(function _callee13$(_context13) {while (1) {switch (_context13.prev = _context13.next) {case 0:_context13.next = 2;return (

                  this.web3Connection.login());case 2:loginOk = _context13.sent;
                if (loginOk) this._loadDataFromWeb3Connection();return _context13.abrupt('return',
                loginOk);case 5:case 'end':return _context13.stop();}}}, _callee13, this);}));function login() {return _ref18.apply(this, arguments);}return login;}()
    ...
    /**
                                                                                                                                                                        ...
                                                                                                                                                                        */ }, { key: 'getETHNetwork', value: function () {var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14() {return _regenerator2.default.wrap(function _callee14$(_context14) {while (1) {switch (_context14.prev = _context14.next) {case 0:_context14.next = 2;return (

                  this.web3Connection.getETHNetwork());case 2:return _context14.abrupt('return', _context14.sent);case 3:case 'end':return _context14.stop();}}}, _callee14, this);}));function getETHNetwork() {return _ref19.apply(this, arguments);}return getETHNetwork;}()
    ...
    /**
                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                 */ }, { key: 'getUserAddress', value: function () {var _ref20 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15() {return _regenerator2.default.wrap(function _callee15$(_context15) {while (1) {switch (_context15.prev = _context15.next) {case 0:_context15.next = 2;return (

                  this.web3Connection.getAddress());case 2:return _context15.abrupt('return', _context15.sent);case 3:case 'end':return _context15.stop();}}}, _callee15, this);}));function getUserAddress() {return _ref20.apply(this, arguments);}return getUserAddress;}()
    ...
    /**
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                */ }, { key: 'getUserETHBalance', value: function () {var _ref21 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee16() {return _regenerator2.default.wrap(function _callee16$(_context16) {while (1) {switch (_context16.prev = _context16.next) {case 0:_context16.next = 2;return (

                  this.web3Connection.getETHBalance());case 2:return _context16.abrupt('return', _context16.sent);case 3:case 'end':return _context16.stop();}}}, _callee16, this);}));function getUserETHBalance() {return _ref21.apply(this, arguments);}return getUserETHBalance;}() }]);return IContract;}();var _initialiseProps = function _initialiseProps() {var _this = this;this.__init__ = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17() {return _regenerator2.default.wrap(function _callee17$(_context17) {while (1) {switch (_context17.prev = _context17.next) {case 0:_context17.prev = 0;if (_this.getAddress()) {_context17.next = 3;break;}throw new Error('Please add a Contract Address');case 3:_context17.next = 5;return _this.__assert();case 5:_context17.next = 10;break;case 7:_context17.prev = 7;_context17.t0 = _context17['catch'](0);throw _context17.t0;case 10:case 'end':return _context17.stop();}}}, _callee17, _this, [[0, 7]]);}));this.__metamaskCall = function () {var _ref23 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee18(_ref24) {var f = _ref24.f,acc = _ref24.acc,value = _ref24.value,_ref24$callback = _ref24.callback,callback = _ref24$callback === undefined ? function () {} : _ref24$callback;return _regenerator2.default.wrap(function _callee18$(_context18) {while (1) {switch (_context18.prev = _context18.next) {case 0:return _context18.abrupt('return', new _promise2.default(function (resolve, reject) {f.send({ from: acc, value: value, gasPrice: 20000000000, // temp test
                  gas: 5913388 // 6721975 //temp test
                }).on('confirmation', function (confirmationNumber, receipt) {callback(confirmationNumber);if (confirmationNumber > 0) {resolve(receipt);}}).on('error', function (err) {reject(err);});}));case 1:case 'end':return _context18.stop();}}}, _callee18, _this);}));return function (_x5) {return _ref23.apply(this, arguments);};}();this.__sendTx = function () {var _ref25 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee19(f) {var call = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;var value = arguments[2];var callback = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function () {};var res, accounts, data;return _regenerator2.default.wrap(function _callee19$(_context19) {while (1) {switch (_context19.prev = _context19.next) {case 0:_context19.prev = 0;res = void 0;if (!(!_this.acc && !call)) {_context19.next = 12;break;}_context19.next = 5;return _this.params.web3.eth.getAccounts();case 5:accounts = _context19.sent;console.log('---__sendTx.bp0');_context19.next = 9;return _this.__metamaskCall({ f: f, acc: accounts[0], value: value, callback: callback });case 9:res = _context19.sent;_context19.next = 28;break;case 12:if (!(_this.acc && !call)) {_context19.next = 19;break;}data = f.encodeABI();_context19.next = 16;return _this.params.contract.send(_this.acc.getAccount(), data, value).catch(function (err) {throw err;});case 16:res = _context19.sent;_context19.next = 28;break;case 19:if (!(_this.acc && call)) {_context19.next = 25;break;}_context19.next = 22;return f.call({ from: _this.acc.getAddress() }).catch(function (err) {throw err;});case 22:res = _context19.sent;_context19.next = 28;break;case 25:_context19.next = 27;return f.call().catch(function (err) {throw err;});case 27:res = _context19.sent;case 28:return _context19.abrupt('return', res);case 31:_context19.prev = 31;_context19.t0 = _context19['catch'](0);throw _context19.t0;case 34:case 'end':return _context19.stop();}}}, _callee19, _this, [[0, 31]]);}));return function (_x6) {return _ref25.apply(this, arguments);};}();this.__deploy = function () {var _ref26 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee20(params, callback) {return _regenerator2.default.wrap(function _callee20$(_context20) {while (1) {switch (_context20.prev = _context20.next) {case 0:_context20.next = 2;return _this.params.contract.deploy(_this.acc, _this.params.contract.getABI(), _this.params.contract.getJSON().bytecode, params, callback);case 2:return _context20.abrupt('return', _context20.sent);case 3:case 'end':return _context20.stop();}}}, _callee20, _this);}));return function (_x9, _x10) {return _ref26.apply(this, arguments);};}();this.__assert = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee21() {return _regenerator2.default.wrap(function _callee21$(_context21) {while (1) {switch (_context21.prev = _context21.next) {case 0:if (_this.getAddress()) {_context21.next = 2;break;}throw new Error('Contract is not deployed, first deploy it and provide a contract address');case 2: /* Use ABI */_this.params.contract.use(_this.params.abi, _this.getAddress());case 3:case 'end':return _context21.stop();}}}, _callee21, _this);}));this.deploy = function () {var _ref28 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee22(_ref29) {var callback = _ref29.callback;var params, res;return _regenerator2.default.wrap(function _callee22$(_context22) {while (1) {switch (_context22.prev = _context22.next) {case 0:params = [];_context22.next = 3;return _this.__deploy(params, callback);case 3:res = _context22.sent;_this.params.contractAddress = res.contractAddress; /* Call to Backend API */_context22.next = 7;return _this.__assert();case 7:return _context22.abrupt('return', res);case 8:case 'end':return _context22.stop();}}}, _callee22, _this);}));return function (_x11) {return _ref28.apply(this, arguments);};}();};exports.default =
