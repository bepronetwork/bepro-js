...
Contract = function () {
	function Contract(web3, contract_json, address) {var _this = this;(0, _classCallCheck3.default)(this, Contract);this.
		...
		__metamaskDeploy = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref2) {var byteCode = _ref2.byteCode,args = _ref2.args,acc = _ref2.acc,_ref2$callback = _ref2.callback,callback = _ref2$callback === undefined ? function () {} : _ref2$callback;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:return _context.abrupt("return",
			...
			contract_json, address) {return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
								...
								contract_json.abi,
								this.address);case 4:case "end":return _context4.stop();}}}, _callee4, this);}));function use(_x9, _x10) {return _ref5.apply(this, arguments);}return use;}() }, { key: "send", value: function () {var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(
			...
			account, byteCode) {var _this3 = this;var value = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '0x0';var callback = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function () {};return _regenerator2.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:return _context6.abrupt("return",
								new _promise2.default(function () {var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(resolve, reject) {var tx, result;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
														tx = {
															...
															value: value ? value : '0x0' };_context5.next = 3;return (


															account.signTransaction(tx));case 3:result = _context5.sent;
														_this3.web3.eth.sendSignedTransaction(result.rawTransaction).
														on('confirmation', function (confirmationNumber, receipt) {
															callback(confirmationNumber);
															if (confirmationNumber > 0) {
																resolve(receipt);
														...
														on('error', function (err) {reject(err);});case 5:case "end":return _context5.stop();}}}, _callee5, _this3);}));return function (_x15, _x16) {return _ref7.apply(this, arguments);};}()));case 1:case "end":return _context6.stop();}}}, _callee6, this);}));function send(_x11, _x12) {return _ref6.apply(this, arguments);}return send;}() }, { key: "getContract", value: function getContract()
